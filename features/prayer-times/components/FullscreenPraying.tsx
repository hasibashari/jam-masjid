    ...
    <div className="fixed inset-0 z-50 bg-[#000000] text-white flex flex-col items-center justify-between px-[3vw] py-[2.5vh] select-none animate-fade-in overflow-hidden">
      ...
      <div className="w-full flex justify-between items-center border-b border-zinc-800 pb-[1.5vh]">
        <div>
          ...
          <span className="font-black text-[#D4AF37] tracking-tight text-[1.6vw]">SHOLAT BERLANGSUNG</span>
        </div>
        <div className="text-right">
          <span className="text-[#9BB1A5] font-black tracking-[0.3em] uppercase block mb-[0.3vh] text-[0.75vw]">Waktu</span>
          <span className="font-bold font-mono text-[#F7F5F0] text-[1.6vw]">{format(currentTime, 'HH:mm')}</span>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center text-center flex-1 justify-center w-full px-[4vw]">
        ...
        <div
          className="mb-[3vh] border border-zinc-700/60 rounded-full flex items-center justify-center relative"
          style={{ width: '6vw', height: '6vw' }}
        >
          <div
            className="border-2 border-dashed border-[#D4AF37]/50 rounded-full animate-ping absolute"
            style={{ width: '3.5vw', height: '3.5vw' }}
          ></div>
          <div
            className="bg-[#D4AF37]"
            style={{ width: '1.8vw', height: '1.8vw', borderRadius: '50%' }}
          ></div>
        </div>
        ...
        <h1
          className="font-black tracking-tighter text-[#F7F5F0] uppercase leading-none mb-[2vh]"
        ...
        {/* Divider */}
        <div className="bg-zinc-800 mb-[2vh]" style={{ height: '2px', width: '10vw' }}></div>

        {/* Keterangan nama sholat */}
        <p className="text-[#7E9086] font-medium tracking-wide uppercase text-[1.2vw]">
          Sedang melaksanakan ibadah sholat fardhu berjamaah{' '}
          <span className="text-[#9BB1A5] font-extrabold">{prayerName}</span>
        </p>
      </div>

      {/* Bottom Status — peringatan HP, cukup besar terbaca dari jauh */}
      <div className="w-full flex flex-col items-center border-t border-zinc-900 pt-[1.5vh]">
        <span className="text-[#7E9086] font-black tracking-[0.3em] uppercase mb-[0.5vh] text-[0.85vw]">
          Pemberitahuan Khusus
        </span>
        <div className="text-rose-400 animate-pulse font-sans tracking-tight font-black text-[1.4vw]">
          MOHON NON-AKTIFKAN / SILENT HP
        </div>
        <div className="font-mono text-[#9BB1A5] mt-[0.5vh] text-[1vw]">
